...
* `chanceGrow` → Probability of generating a growth stage instead of a static object (young or mature form depending on context). Where lower values favor young forms, higher values favor mature forms, and intermediate values (e.g. 0.3, 0.5) produce a mix based on chance.
